  ...
  Future<void> getData() async {
    ...
    try {
      ...
      var responses = await Future.wait([
        http.get(
          Uri.parse('http://196.43.168.57/api/v1/farms/count'),
          headers: headers,
        ),
        http.get(
        ...
        http.get(
          Uri.parse('http://196.43.168.57/api/v1/farms/time-until-harvest'),
          headers: headers,
        ),
        http.get(
          Uri.parse('http://196.43.168.57/api/v1/farms/supplementary-feeding'),
          headers: headers,
        ),
      ]);
